...
| --- | --- | --- |
| **Pi** (pi-coding-agent) | `~/.pi/skills/worktree-runtime/` (global) or repo `skills/worktree-runtime/` | Repo-local is read by the agent automatically; reload skills after install |
